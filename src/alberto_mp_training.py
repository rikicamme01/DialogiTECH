...
disp = ConfusionMatrixDisplay.from_predictions(y_true, pred, display_labels=labels, normalize='true')
disp.plot(cmap="Blues", values_format='',xticks_rotation='vertical', ax=ax, values_format='0.2g')
